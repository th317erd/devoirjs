...
(function(factory) {
	...
	* @parent devoir.data
	* @function extend
	* @param {Object|Boolean|Number} {[flags]} If a Boolean, specify if this is a deep copy. If an Object, will be considered the first of <b>args</b>. If a Number, this is a bitwise combination of flags. Flags include: devoir.data.extend.DEEP, devoir.data.extend.NO_OVERWRITE, and devoir.data.extend.FILTER. If the 'FILTER' flag is specified the 2nd argument is expected to be a function to assist in which keys to copy.
